...
ema_sleep_long_fp <- "~/Dropbox/JSK_SC/_scripts/2_at-home_wrangling/mw_daily_sleep_longform.csv"
...
```{r, message=FALSE}
emo_long_fp <- "~/Dropbox/JSK_SC/_scripts/4_aim2/MW_daily_emo_data_longform.csv"
mw_emo <- 
...
act_sleep_long_fp <- "~/Dropbox/JSK_SC/_scripts/2_at-home_wrangling/act_daily_sleep_longform.csv"
