...
sleep_mw_usable_fp <- "~/Dropbox/JSK_SC/EMA/2_daily_sleep_usable_data.csv"
...
```{r}
write_csv(sleep_merge5, "~/Dropbox/JSK_SC/_scripts/2_at-home_wrangling/mw_daily_sleep_longform.csv")
```
...
```{r}
write_csv(mw_sleep_red, "~/Dropbox/JSK_SC/_scripts/2_at-home_wrangling/EMA_daily_sleep_data_reduced.csv")
```
